...
class TcpConnection : boost::noncopyable,
                      public boost::enable_shared_from_this<TcpConnection>//这个继承是为了使用shared_from_this函数
{
 public:
  ...
  void shutdown(); // NOT thread safe, no simultaneous calling 不是线程安全的
 ...
 private:
  ...
  //kConnecting正在连接kConnected连接成功kDisconnected是处于消毁状态kDisconnecting正在断开状态
...
typedef boost::shared_ptr<TcpConnection> TcpConnectionPtr; //连接对象指针
